...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"testME", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Test ME."),
			NULL,
			GUC_EXPLAIN
		},
		&testME,
	...
	{
		{"enableQuartet", PGC_USERSET, QUERY_TUNING_OTHER,
			gettext_noop("Enable Quartet."),
			NULL,
			GUC_EXPLAIN
		},
		&enableQuartet,
	...
	{
		{"enableExprCount", PGC_USERSET, QUERY_TUNING_OTHER,
...
static struct config_string ConfigureNamesString[] =
{
	...
	// ----------------------------- #RAIN ----------------------------- 
	{
		{"levelsFile", PGC_SIGHUP, LOGGING_WHERE,
			gettext_noop("Sets the expr levels."),
			NULL,
			GUC_SUPERUSER_ONLY
		},
		&levelsFile,
		"/data/ExprLevel/levels.csv",
		NULL, NULL, NULL
	},
	// ----------------------------- #RAIN ----------------------------- 
