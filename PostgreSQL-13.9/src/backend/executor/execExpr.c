...
// Get EEOP name
const char* getExprEvalOpName(ExprEvalOp op) 
{
    switch(op) 
	{
        case EEOP_DONE: return "EEOP_DONE";
        ...
        case EEOP_ARRAYCOERCE: return "EEOP_ARRAYCOERCE";
        ...
        case EEOP_SBSREF_SUBSCRIPT: return "EEOP_SBSREF_SUBSCRIPT";
        ...
        case EEOP_ALTERNATIVE_SUBPLAN: return "EEOP_ALTERNATIVE_SUBPLAN";
        ...
        case EEOP_AGG_STRICT_INPUT_CHECK_NULLS: return "EEOP_AGG_STRICT_INPUT_CHECK_NULLS";
        ...
        default: return "Unknown ExprEvalOp";
    }
}
