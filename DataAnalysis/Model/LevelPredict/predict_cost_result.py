...
# 加载模型
model_path = "./data/model_param/ME_cost/model_final.pkl"
model = torch.load(model_path)
model.eval()  # 设置模型为评估模式

# 使用 joblib 加载 scaler
scaler = joblib.load('./data/model_param/ME_cost/scaler.pkl')

# 读取新数据
predict_data = pd.read_csv('data/predict_data_cost.csv')
...
# 保存文件
prediction_df.to_csv('./data/predict_result/ME_cost/predictions.csv', index=False)
...
# 保存聚合后的结果
aggregated_df.to_csv('./data/predict_result/ME_cost/aggregated_predictions.csv', index=False)
